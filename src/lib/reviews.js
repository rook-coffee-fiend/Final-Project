...
export const reviews = [
    {
        id: 0,
          name: "Meet Buddy & Co",//Emily & Julian
          descr: "The silliest trio",//Buddy, Buffy, & Felix's parents
          img: Buddy, 
          review: "Featured kitty: Buddy! Buddy is the most dapper man in the whole world. His tuxie brother Felix is a food goblin who will fully eat through plastic to get at anything remotely edible, and their all-black sister Buffy has to be kept away from Buddy at all times, or she'll try to fight him."
      },
    {
        id: 1,
          name: "Lindsay & Maggie",
    ...
    {
        id: 3,
          name: "Meet Nanette", //Louise
          descr: "A sweet old lady", //Nanette's mom
          img: Nanette, 
      ...
      {
        id: 4,
          name: "Meet Jasper and Pooky", //Natalie
          descr: "Adopted brothers and the best of friends", //Jasper and Pooky's mom
          img: JasperI, 
      ...
      {
        id: 5,
          name: "Meet Daphne, Gepetto, and Nugget", //Morgan
          descr: "Some special-needs kitties", //Daphne, Gepetto, and Nugget's mom
          img: Nugget, 
      ...
      {
        id: 6,
          name: "Meet Toula", //Samantha
          descr: "Huntress and snugglebug", //Toula's mom
          img: Toula, 
      ...
      {
        id: 9,
          name: "Meet Moose", //Erica
          descr: "King of snuggle mountain",
          img: Moose, 
      ...
      {
        id: 10,
          name: "Meet Jasper", //Maya
          descr: "A little guy with a lot of love!", //Jasper's mom
          img: JasperII, 
      ...
      {
        id: 11,
          name: "Meet Herbie", //Leslie & Sarah
          descr: "The chattiest boy in all the land", //Herbie's moms
          img: Herbie, 
